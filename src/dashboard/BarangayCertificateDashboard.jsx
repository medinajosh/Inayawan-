...
const BarangayCertificateDashboard = () => {
  ...
  return (
    <div className="p-8 bg-gradient-to-r from-blue-100 to-blue-300">
      <h2 className="text-4xl font-extrabold text-blue-800 mb-6"> Barangay Certificate Dashboard</h2>
...
export default BarangayCertificateDashboard;
