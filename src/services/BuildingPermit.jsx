...
const BuildingPermit = ({ closeModal }) => {
  ...
  const fetchRequests = async () => {
    const querySnapshot = await getDocs(collection(firestore, "buildingPermitRequests"));
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await addDoc(collection(firestore, "buildingPermitRequests"), newRequest);
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white bg-opacity-90 p-6 rounded-lg shadow-lg max-w-md w-full z-50">
        ...
        <h2 className="text-2xl font-bold text-center text-blue-700 mb-6">Request Building Permit</h2>
        <p className="text-lg text-gray-600 mb-8 text-center">Fill in the details to request a building permit.</p>
